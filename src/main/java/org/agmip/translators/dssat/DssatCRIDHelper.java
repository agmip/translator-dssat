...
public class DssatCRIDHelper {
    ...
    private String def2BitVal = "XX";       // default 2-bit value for unknow crid
    private String def3BitVal = "XXX";      // default 3-bit value for unknow crid
     ...
     */
    public String get2BitCrid(String str) {
        if (str == null) {
            return def2BitVal;
     ...
     */
    public String get3BitCrid(String str) {
